...
const berean_translit = berean_transliteration['bereanTransliteration'];
...
function getTransliteratedVerse(osisRef) {
    const index = converters.convertOsisRefToIndex(osisRef);
    return berean_translit[index] || null;
}

export { getBibleVerse, getBibleVerses, getOriginalTextVerses, getOriginalTextVerse, getTransliteratedVerse, getTransliteratedVerses };
